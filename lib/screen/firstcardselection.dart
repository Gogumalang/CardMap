...
class FirstCardSelection extends StatefulWidget {
  const FirstCardSelection({super.key});

  @override
  State<FirstCardSelection> createState() => _FirstCardSelectionState();
}

class _FirstCardSelectionState extends State<FirstCardSelection> {
  String pClicked = '서울';
  String cClicked = '전체';
  String cardClicked = '';
